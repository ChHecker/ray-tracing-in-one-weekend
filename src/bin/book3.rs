...
fn main() {
    ...
    let raytracer = match scene {
        Scene::Random => {
            path = Path::new("images/book3-random.png");
            random_world(
                aspect_ratio,
                image_width,
                image_height,
        ...
        Scene::Checkerboard => {
            path = Path::new("images/book3-checkerboard.png");
            checkerboard_world(
                aspect_ratio,
                image_width,
                image_height,
        ...
        Scene::Perlin => {
            path = Path::new("images/book3-perlin.png");
            perlin(
                aspect_ratio,
                image_width,
                image_height,
        ...
        Scene::Image => {
            path = Path::new("images/book3-image.png");
            image(
                aspect_ratio,
                image_width,
                image_height,
        ...
        Scene::Light => {
            path = Path::new("images/book3-light.png");
            light(
                aspect_ratio,
                image_width,
                image_height,
        ...
        Scene::Cornell => {
            path = Path::new("images/book3-cornell.png");
            cornell(
                aspect_ratio,
                image_width,
                image_height,
        ...
        Scene::Final => {
            path = Path::new("images/book30-final.png");
            final_scene(
                aspect_ratio,
                image_width,
                image_height,
